...
# parameter fixed at epsilon = 3.1. Same specification and the same
# treatment regressions; the figures are omitted, as in the MATLAB original
# (GTFM_MatlabPrograms/regions/imperfmobdata_eps3.m).

# Run from this folder:  julia imperfmobdata_eps3.jl
